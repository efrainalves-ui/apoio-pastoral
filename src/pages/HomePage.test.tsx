...
const services = vi.hoisted(() => ({ listPeople: vi.fn(() => Promise.resolve(people)), getDistrict: vi.fn(() => Promise.resolve(null)), listFamilies: vi.fn(() => Promise.resolve([])), listEvents: vi.fn(() => Promise.resolve([])), listTasks: vi.fn(() => Promise.resolve([])), listPrayerRequests: vi.fn(() => Promise.resolve([{ id: 'prayer-fictitious', status: 'active', text: 'Conteúdo reservado fictício' }])), listFollowUps: vi.fn(() => Promise.resolve([])), listRounds: vi.fn(() => Promise.resolve([])), listCampaigns: vi.fn(() => Promise.resolve([])) }))
