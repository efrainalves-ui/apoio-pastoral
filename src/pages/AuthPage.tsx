...
export function AuthPage() {
  const { account, register, unlock, recover, completeReset, recoveryCode, clearRecoveryCode, awaitingConfirmation, resendConfirmation, sendPasswordReset, sessionLostMessage } = useAuthVault()
