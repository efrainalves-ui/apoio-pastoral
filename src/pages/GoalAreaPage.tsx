    ...
    <div className="page-stack page-narrow goal-area-page">
      ...
      <Card title="No ano">
        ...
        {/*
          ...
          conseguiu porque falta combinar a meta é esconder a parte boa.
        */}
        {progresso.target === 0 && progresso.result > 0 && <p className="card-copy">
          {formatGoalValue(area, progresso.result)} já realizado. A meta do ano ainda não foi definida.
        </p>}
