...
export function InitialSetupPage() {
  ...
  async function readFile(file?: File) {
    ...
    try {
      ...
      setChurches(parsedChurches); setMembers(parsedMembers); setUnparsedCount(parsed.unparsedLines.length); setStep('review')
