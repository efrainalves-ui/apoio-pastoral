...
export interface QuestionSnapshot { code: string; version: number; category: string; text: string; scope: QuestionScope; responseType: QuestionResponseType; options: string[]; sensitivity: 'pastoral' | 'health_general' | 'prayer' }
