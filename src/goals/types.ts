export type GoalMetric = 'tithes_offerings' | 'baptisms' | 'rebaptisms' | 'professions_faith'
...
export const GOAL_LABELS: Record<GoalMetric, string> = { tithes_offerings: 'Dízimos e ofertas', baptisms: 'Batismos', rebaptisms: 'Rebatismos', professions_faith: 'Profissões de fé' }
