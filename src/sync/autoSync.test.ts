...
import { deveSincronizarAgora, ESPERA_APOS_ALTERACAO_MS, INTERVALO_OCIOSO_MS } from './autoSync'

const base = { online: true, emCurso: false, pendentes: 0, ultimaRodada: 0, agora: 0 }
