...
export interface NominationReportVersion { id: string; version: number; createdAt: string; presentationDate: string; officialVoteDate: string; lines: NominationReportLine[]; openOffices: string[]; publicNote: string }
