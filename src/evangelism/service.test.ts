...
describe('Planejamento Anual e Evangelismo integrados', () => {
  ...
  it('calcula atenção, resumo anual, relatório local e preserva registros ao excluir vínculos', async () => {
    ...
    expect(annualSummary([savedGoal], [savedCampaign], 2026, '2026-08-31')).toMatchObject({ planned: 1, campaigns: 0 })
    expect(annualSummary([savedGoal], [savedCampaign], 2026, '2026-09-09')).toMatchObject({ campaigns: 1 })
