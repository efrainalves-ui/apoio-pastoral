...
const TYPE_LABELS: Record<string, string> = {
  ...
  agenda_event: 'Agenda do distrito', sermon: 'Sermões', sermon_preaching: 'Pregações já feitas', goal: 'Metas', goal_entry: 'Lançamentos de metas',
  goal_history: 'Resultados de anos anteriores', visit: 'Visitas', wedding: 'Casamentos', reminder: 'Lembretes', reminder_list: 'Listas de lembretes', reminder_meta: 'Marcações de tarefas', prayer_request: 'Pedidos de oração',
