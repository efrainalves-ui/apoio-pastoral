...
- Auditoria de isolamento entre duas contas fictícias, em seis cenários, e prova de banco com as guardas de view, função e armazenamento.
- `pnpm audit` sem vulnerabilidades conhecidas, com e sem dependências de desenvolvimento.
...
- O topo oferece busca local permanente por pessoa, família, igreja e compromisso, além das ações de criar e sincronizar.
...
- No Orçamento Familiar, o resumo do mês mostrou as barras de entradas e saídas, a projeção e a dica com ícone; no tema escuro, Editar mediu 10,27:1, Mês atual 12,97:1 e a aba ativa 10,95:1, contra 10,52:1 e 8,65:1 no tema claro.
- Metas registrou o consolidado fictício de 2025 em Batismos e mostrou a comparação completa sem mexer nos números de 2026; o cartão da área repetiu a mesma leitura.
- Uma campanha fictícia foi criada com a igreja envolvida em primeiro lugar e com as duas metas criadas na hora; a tela interna mostrou as metas ligadas com o resultado real. Na conferência visual, o botão Acrescentar item ficou com 46px de altura, largura total do bloco e contraste de borda de 3,16:1 no tema claro e 4,03:1 no escuro; em 375px a página ficou em uma coluna, sem rolagem horizontal e sem botão cortado.
- Pedidos de Oração começou com a tela vazia — só título, botão e o convite para cadastrar o primeiro pedido — e depois abriu o acompanhamento por igreja, pessoa e pedido, com atualização, mudança de situação, encerramento e exclusão confirmados em dados fictícios.
