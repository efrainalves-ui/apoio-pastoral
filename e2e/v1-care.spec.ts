...
test('agenda, visita versionada, cuidado e rodada funcionam no armazenamento offline', async ({ page, context }) => {
  ...
  await navigateInsideApp(page, '/app/agenda/novo')
  ...
  await navigateInsideApp(page, '/app/cuidados')
  ...
  await navigateInsideApp(page, '/app/visitas/nova')
  ...
  await navigateInsideApp(page, '/app/visitas')
